...
namespace Breeze.WebApi {
  ...
  public class EFContextProvider<T> : ContextProvider where T : class, new() {
    ...
    protected override void SaveChangesCore(SaveWorkState saveWorkState) {
      ...
      try {
        ...
        foreach (var eve in e.EntityValidationErrors) {
          ...
          if (key.EntityKeyValues != null) {
            ...
            var entityInfo = EntitiesWithAutoGeneratedKeys.FirstOrDefault(ei => ei.Entity == entity);
            if (entityInfo != null) {
              var formattedKey = key.EntitySetName + ";(Temporary Key);" +
                                 entityInfo.AutoGeneratedKey.TempValue;
              msg += String.Format("\n'{0}' has the following validation errors:", formattedKey);
            } else {
      ...
      saveWorkState.KeyMappings = UpdateAutoGeneratedKeys();
    }
